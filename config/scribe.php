...
return [
    ...
    'title' => 'DonorYuks API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'REST API backend untuk aplikasi DonorYuks — platform digital yang menghubungkan pendonor darah dengan penerima/pasien secara real-time dan berbasis lokasi.
...
Fitur utama: autentikasi (Sanctum), profil & kartu donor digital, geo-matching permintaan darah (Haversine), booking event donor, gamifikasi reward, dan AI Chatbot kesehatan "Bloody".',
    ...
    'auth' => [
        ...
        'extra_info' => 'Token Sanctum diperoleh dengan memanggil <code>POST /api/login</code> atau <code>POST /api/register</code>. Kirim token pada header <code>Authorization: Bearer {token}</code>.',
    ],
